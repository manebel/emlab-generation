createMeritOrderDF2<-function(scenarioName,demand1,
                             demand2=0,
                             ...
                             numberCoal=90,costsCoal=58.16,costsCoal2=0,
  ...
  result<-rbind(renewableDF,nuclearDF,ccgtDF,coalDF,ocgtDF)
  result$technology<-factor(result$technology,levels=c("Renewables","Nuclear","CCGT","Coal","OCGT"))
