...
meritOrderPlot<-ggplot(bigDF, aes(x=capacity, y=costs))+
  ...
  scale_fill_grey(start = 0.2, end = .8,name="Technology")+
  scale_linetype_manual(name = "Demand and Price",
...
ggsave(filename="meritOrder-DemandRisk.pdf",plot=meritOrderPlot, width=20, height=20, units="cm")